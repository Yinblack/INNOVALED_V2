...
function showFirstSublinea(){
    $("a.goProductosSublinea").first().trigger('click');
    console.log('in show');
}
          ...
          success: function(data){
            if (data=='Nan') {
              ...
              for (var i = jsonObj.length - 1; i >= 0; i--) {
                    ...
                    $('<div class="col-xs-12 item" id="'+id+'"><div class="col-xs-4"><div class="col-xs-12 nopadding verticalContainer"><div class="col-xs-12 vertical nopadding text-center"><h4 class="regular nomargin">'+name+'</h4></div></div></div><div class="col-xs-3 containerNoItems"><div class="col-xs-12 nopadding vertical"><div class="col-xs-12 nopadding"><div class="col-xs-4 nopadding text-center"><a href="#" class="square centered action" act="minus">-</a></div><div class="col-xs-4 nopadding text-center"><input type="text" class="square centered" id="qty" name="qty" rowid="'+rowid+'" value="'+qty+'"><input type="hidden" id="price" name="price" value="'+price+'"></div><div class="col-xs-4 nopadding text-center"><a href="#" class="square centered action" act="plus">+</a></div></div></div></div><div class="col-xs-2"><div class="col-xs-12 nopadding verticalContainer"><div class="col-xs-12 nopadding vertical text-center"><span>S/ '+price+'</span></div></div></div><div class="col-xs-2"><div class="col-xs-12 nopadding verticalContainer"><div class="col-xs-12 nopadding vertical text-center"><span id="'+rowid+'">'+totalPrecioByProducto+'</span></div></div></div><div class="col-xs-1"><div class="col-xs-12 nopadding verticalContainer"><div class="col-xs-12 nopadding vertical text-center"><a onclick="deleteItemFromCart('+id+');"><i class="fa fa-trash" aria-hidden="true"></i></a></div></div></div></div>').appendTo('div#containerItemsCart');
                }
            }
            var cart=$('div.partCart');
            cart.slideDown(100);
        ...
        success: function(data){
          if (data=='success') {
            noty({
              ...
              var numItems=$('a.cart>span.noItems').html();
              numItems=parseInt(numItems);
              var newNumitems=numItems-1;
              $('a.cart>span.noItems').html(newNumitems);
              if (newNumitems==0) {
